                  ...
                  <div className="text-center p-5" style={{background:" rgba(51, 33, 29, .8)"}}>
                      ...
                      <form className="mb-5">
                          <div className="form-group">
                              <input value={name} onChange={e=>setName(e.target.value)} type="text" className="form-control bg-transparent border-primary p-4" placeholder="Name"
                                  required="required" />
                          </div>
                          <div className="form-group">
                          ...
                          <div>
                              <button onClick={reserve} className="btn btn-primary btn-block font-weight-bold py-3" type="submit">Book Now</button>
                          </div>
                      </form>
                  </div>
              </div>
